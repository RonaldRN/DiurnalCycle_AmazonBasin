...
diurno da precipitação na Bacia Amazônica" para o período de MAM.
...
print('Rodando código para o período de MAM')
...
print('3. Read of datasets para o período de MAM')
ds_files = '/home/ronald/MAM/3B-HHR.*.nc4'
...
print('Escrevendo os dados em formato Netcdf para MAM')
harm_array.to_netcdf('diurnal_cycle_MAM.nc')
print('33. Arquivo NetCDF para MAM criado')
