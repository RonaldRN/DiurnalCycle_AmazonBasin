...
diurno da precipitação na Bacia Amazônica" para o período de SON.
...
print('Rodando código para o período de SON')
...
print('3. Read of datasets para o período de SON')
ds_files = '/home/ronald/SON/3B-HHR.*.nc4'
...
print('Escrevendo os dados em formato Netcdf para SON')
harm_array.to_netcdf('diurnal_cycle_SON.nc')
print('33. Arquivo NetCDF para SON criado')
